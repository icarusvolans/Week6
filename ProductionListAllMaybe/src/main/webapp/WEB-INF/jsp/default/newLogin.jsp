...
<form:form modelAttribute="teamMember" method="POST" enctype="utf8">
    ...
    <tr><td>
        <label>
            <spring:message code="label.teamMember.firstName"></spring:message>
        </label>
    </td>
    ...
    <tr><td>
        <label>
            <spring:message code="label.teamMember.lastName"></spring:message>
        </label>
    </td>
    ...
    <tr><td>
        <label>
            <spring:message code="label.teamMember.email"></spring:message>
        </label>
    </td>
    ...
    <tr><td>
        <label>
            <spring:message code="label.teamMember.password"></spring:message>
        </label>
    </td>
        <td>
    ...
    <tr><td>
        <label>
            <spring:message code="label.teamMember.confirmPass"></spring:message>
        </label>
    </td>
